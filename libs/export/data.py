...
class DataExport:
    ...
    @staticmethod
    def consumption_adsl_by_state(data: DataHandler, filepath: str | None = None) -> bool:
    ...
    @staticmethod
    def consumption_mdu_by_state(data: DataHandler, filepath: str | None = None) -> bool:
    ...
    @staticmethod
    def consumption_olt_by_state(data: DataHandler, filepath: str | None = None) -> bool:
    ...
    @staticmethod
    def consumption_by_state(data: DataHandler, filepath: str | None = None) -> bool:
