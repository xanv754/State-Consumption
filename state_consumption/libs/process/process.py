import pandas as pd
from state_consumption.constants.columns import NameColumns, BossNewNameColumns
...
class ProcessHandler:
    ...
    def _adsl_filter(self, df: pd.DataFrame) -> None:
    ...
    def _mdu_filter(self, df: pd.DataFrame) -> None:
    ...
    def export_missing_bras(self) -> None:
        ...
        self._calculate.export_missing_bras()
    ...
    def total_clients_adsl(self) -> pd.DataFrame:
        ...
        return self._calculate.total_clients_adsl_mdu(self.data_adsl)
    
    def total_clients_mdu(self) -> pd.DataFrame:
        """Totalize clients MDU."""
        return self._calculate.total_clients_adsl_mdu(self.data_mdu)
    
    def total_clients_olt(self) -> pd.DataFrame:
        """Totalize clients OLT."""
        return self._calculate.total_clients_olt(self.data_olt)
    ...
    def total_consumption_adsl_by_bras(self) -> pd.DataFrame: #
        ...
        return self._calculate.total_consumption_equipment_by_bras(df_total_clients_adsl_by_bras, df_total_clients_by_bras, self.data_consumption, brasnames)
    ...
    def total_consumption_mdu_by_bras(self) -> pd.DataFrame:
        ...
        return self._calculate.total_consumption_equipment_by_bras(df_total_clients_mdu_by_bras, df_total_clients, self.data_consumption, brasnames)
    ...
    def total_consumption_olt_by_bras(self) -> pd.DataFrame:
        ...
        return self._calculate.total_consumption_equipment_by_bras(df_total_clients_olt_by_bras, df_total_clients, self.data_consumption, brasnames)
    ...
    def total_consumption_state_adsl_by_bras(self) -> pd.DataFrame:
        ...
        return self._calculate.total_consumption_state_equipment_by_bras(df_consumption_adsl_by_bras, df_clients_adsl_by_state, df_clients_adsl_by_bras)
    ...
    def total_consumption_state_mdu_by_bras(self) -> pd.DataFrame:
        ...
        return self._calculate.total_consumption_state_equipment_by_bras(df_consumption_mdu_by_bras, df_clients_mdu_by_state, df_clients_mdu_by_bras)
    ...
    def total_consumption_state_olt_by_bras(self) -> pd.DataFrame:
        ...
        return self._calculate.total_consumption_state_equipment_by_bras(df_consumption_olt_by_bras, df_clients_olt_by_state, df_clients_olt_by_bras)
    ...
    def total_consumption_adsl_by_state(self) -> pd.DataFrame:
        ...
        return self._calculate.total_consumption_equipment_by_state(df_consumption_state_adsl_by_bras)
    ...
    def total_consumption_mdu_by_state(self) -> pd.DataFrame:
        ...
        return self._calculate.total_consumption_equipment_by_state(df_consumption_state_mdu_by_bras)
    ...
    def total_consumption_olt_by_state(self) -> pd.DataFrame:
        ...
        return self._calculate.total_consumption_equipment_by_state(df_consumption_state_olt_by_bras)
    ...
    def percentage_consumption_adsl_by_state(self) -> pd.DataFrame:
        ...
        return self._calculate.percentage_consumption_by_state(df_consumption_adsl_by_state, total_consumption_bras)
    ...
    def percentage_consumption_mdu_by_state(self) -> pd.DataFrame:
        ...
        total_consumption_bras = self.data_consumption[NameColumns.CONSUMPTION].sum()
        return self._calculate.percentage_consumption_by_state(df_consumption_mdu_by_state, total_consumption_bras)
    ...
    def percentage_consumption_olt_by_state(self) -> pd.DataFrame:
        ...
        total_consumption_bras = self.data_consumption[NameColumns.CONSUMPTION].sum()
        return self._calculate.percentage_consumption_by_state(df_consumption_olt_by_state, total_consumption_bras)